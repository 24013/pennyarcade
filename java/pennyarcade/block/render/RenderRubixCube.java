...
public class RenderRubixCube extends TileEntitySpecialRenderer {
	...
	private final ModelRubixCube model;
	private ResourceLocation textures;

	public RenderRubixCube() {
		this.model = new ModelRubixCube();
	}
	...
	public void renderTileEntityAt(TileEntity te, double x, double y, double z,
		...
		ResourceLocation textures = (new ResourceLocation(PennyArcade.MODID + ":textures/blocks/model/toys/rubix/RubixCube1.png")); 
