...
public class RenderMiniHerobrine extends TileEntitySpecialRenderer {
	private final ModelClawMachine model;

	public RenderMiniHerobrine() {
	...
	public void renderTileEntityAt(TileEntity te, double x, double y, double z,
		...
		ResourceLocation textures = new ResourceLocation(PennyArcade.MODID
				+ ":textures/blocks/model/toys/players/Herobrine.png");
		Minecraft.getMinecraft().renderEngine.bindTexture(textures);

		GL11.glPushMatrix();
		TileEntityMiniHerobrine myTile = (TileEntityMiniHerobrine) te;
