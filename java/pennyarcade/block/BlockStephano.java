...
public class BlockStephano extends BlockContainer {
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack stack) {
		...
		TileEntityStephano tile = (TileEntityStephano) world.getTileEntity(x, y, z);
     ...
     public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
     {
    	 ...
    	 par1World.playSoundAtEntity(par5EntityPlayer, "pennyarcade:toys.stephano", 1.0F, 1.05F);
    	 return true;
     }
     
     public void registerBlockIcons(IIconRegister icon) {
         this.blockIcon = icon.registerIcon(PennyArcade.MODID + ":stephano");
 }
