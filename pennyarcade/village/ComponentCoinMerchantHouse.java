...
public class ComponentCoinMerchantHouse extends ComponentVillage
{
    public ComponentCoinMerchantHouse() {}

    public ComponentCoinMerchantHouse(ComponentVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5)
    {
    ...
    public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
    {
        ...
        this.placeBlockAtCurrentPosition(par1World, Block.enchantmentTable.blockID, 0, 7, 1, 1, par3StructureBoundingBox);
